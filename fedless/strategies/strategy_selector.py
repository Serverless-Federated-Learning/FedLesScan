...
def selectStrategy(strategy: str, invocation_attrs: dict):
    ...
    switcher = {
        ...
        "fedless_enhanced":FedlessStrategy(selectionStrategy = DBScanClientSelection(invocation_attrs["mongodb_config"], invocation_attrs["session"]),**invocation_attrs),
        "fedless": FedlessStrategy(selectionStrategy = RandomClientSelection(),**invocation_attrs),
        "fedless_mock": MockFedlessStrategy(selectionStrategy = DBScanClientSelection(invocation_attrs["mongodb_config"], invocation_attrs["session"]),**invocation_attrs),
    }
