...
from fedless.benchmark.fedkeeper_indep import ClusterConfig, FedlessStrategy
...
def run(
    ...
    log_dir = (
        ...
        / f"logs_fedless_mnist_{n_clients}_{clients_per_round}_{allowed_stragglers}_{accuracy_threshold}"
    )
